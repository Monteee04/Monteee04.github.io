(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.kennedi,400,270,7,0.8);
        collectable.create(type.grace, 500 ,400, 9, 0.10);
        collectable.create(type.db, 150, 370,10,0.9);
        collectable.create(type.max,570, 400,10,0.5);
